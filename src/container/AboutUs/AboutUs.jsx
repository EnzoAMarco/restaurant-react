  ...
  <div className='app__aboutus app__bg flex__center section__padding'>
    ...
    <div className='app__aboutus-content flex__center'>
      ...
      <div className='app__aboutus-content_about'>
        ...
        <img src={images.spoon} alt='about_cuchara' className='spoon__img' />
        <p className='p__opensans'>
        Sit tellus lobortis sed senectus vivamus molestie. Condimentum volutpat morbi facilisis quam scelerisque sapien. Et, penatibus aliquam amet tellus
        </p>
        <button type='button' className='custom__button'>Mas Información</button>
      </div>

      <div className='app__aboutus-content_knife flex__center'>
        <img src={images.knife} alt='about_cuchillo' />
      </div>
